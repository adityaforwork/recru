  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        // Map parsed Excel columns to candidate structure
        ...
        setError(
          "Error parsing the file. Please ensure columns match the template.",
        );
      }
    };
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-gray-700 uppercase tracking-wider">
                  Parsed Candidates Preview ({previewData.length} records)
                </span>
              ...
              {previewData.length > 5 && (
                <p className="text-[11px] text-gray-400 text-center">
                  + {previewData.length - 5} more records will be imported
                </p>
              )}
            </div>
          )}
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50/50">
          ...
          <button
            ...
            className="px-5 py-2 rounded-lg bg-blue-600 text-xs font-semibold text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-xs"
          >
